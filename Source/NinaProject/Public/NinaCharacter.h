...
#include "NinaCharacter.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE(FFallingDelegate);

UCLASS()
class NINAPROJECT_API ANinaCharacter : public ABaseCharacter
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintAssignable, Category = "CodeDispatcher")
		FFallingDelegate OnFallingDelegate;
