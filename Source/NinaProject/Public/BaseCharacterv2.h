...
UENUM(BlueprintType)
enum class EInteractionType2 : uint8 {
	Push UMETA(DisplayName = "Push"),
	Grab UMETA(DisplayNAme = "Grab")
};

UCLASS()
class NINAPROJECT_API ABaseCharacterv2 : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	void CheckFrontObject(EInputType2 InputType);
	void SetAltMovement();
